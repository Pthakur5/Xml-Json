package com.piyushbbk.xml_json;
...
public class MainActivity2 extends AppCompatActivity {
    ...
    private static String getValue(String tag, Element element) {
        NodeList nodeList = element.getElementsByTagName(tag).item(0).getChildNodes();Node node =
                nodeList.item(0);
    ...
    public void parseJson()
    {
        try {
            ...
            String readData=new String(data); JSONObject jsonObject=new JSONObject(readData);
